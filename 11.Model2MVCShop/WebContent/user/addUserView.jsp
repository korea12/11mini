			...
			$("#userId").on("keyup", function(){
				...
				$.ajax({
					...
					success : function(JSONData){
						...
						if(JSONData){
							$('#chkMsg').html("<p style='color:green'> 사용가능한 아이디입니다.</p>");
							$("#join").html("<button type='button' class='btn btn-primary'>가 &nbsp;입</button>")
						}else{
							$('#chkMsg').html("<p style='color:red'>이미 존재하는 아이디입니다.</p>");
							$("#join").html("")
						}
		...
		$(function(){
			$("#pass1, #pass2").on("keyup",function(){
				if($('#pass1').val()=='' || $('#pass2').val()==''){
					...
					var pass2 = $("#pass2").val();
					if(pass1==pass2){
						$('#chkPassMsg').html("<p style='color:green'> 비밀번호가 일치합니다.</p>");
					}else{
						$('#chkPassMsg').html("<p style='color:red'> 비밀번호가 일치하지 않습니다.</p>");
					}
				}
			});
		});
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="password" class="form-control" id="pass1" name="password" placeholder="비밀번호">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="password" class="form-control" id="pass2" name="password2" placeholder="비밀번호 확인">
		      <span id="chkPassMsg"></span>
		    </div>
		  </div>
